...
# Load the data first
input_ids_train=np.load('input_ids_train_position222.npy', allow_pickle=True)
attention_masks_train=np.load('attention_masks_train_position222.npy', allow_pickle=True)
padded_labels_train=np.load('padded_labels_train_position222.npy', allow_pickle=True)
input_ids_dev=np.load('input_ids_dev_position2.npy', allow_pickle=True)
attention_masks_dev=np.load('attention_masks_dev_position2.npy', allow_pickle=True)
padded_labels_dev=np.load('padded_labels_dev_position2.npy', allow_pickle=True)
...
np.save('input_ids_train_position_shuffled_2.npy', input_ids_train)
np.save('attention_masks_train_position_shuffled_2.npy', attention_masks_train)
np.save('padded_labels_train_position_shuffled_2.npy', padded_labels_train)
np.save('input_ids_dev_position_shuffled_2.npy', input_ids_dev)
np.save('attention_masks_dev_position_shuffled_2.npy', attention_masks_dev)
np.save('padded_labels_dev_position_shuffled_2.npy', padded_labels_dev)
...
checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath='checkpoints/model_2_{epoch:02d}-{val_loss:.2f}.weights.h5',
...
model.save('encoder_decoder_with_positions2.keras')
